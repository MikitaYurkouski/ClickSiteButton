...
function Slider() {
            ...
            this.showPrevBtn = null; // document.querySelector(".show-prev-btn"), getElementById меняем на querySelector
            this.showNextBtn = null; // document.querySelector(".show-next-btn"), getElementById меняем на querySelector
            ...
            this.start = function (elId) {
                    ...
                    this.showPrevBtn = el.querySelector(".show-prev-btn"); // el. фнкция работает внутри документа
...
// ПОСЛЕ СОЗДАНИЯ КОНСТРУКТОРА ЭТА ЧАСТЬ КОДА БОЛЬШЕ НЕ НУЖНА. т.к В НЕЙ ТОЛЬКО ОДНА ТОЧКА КОДА КОТОРАЯ
//НУЖНА
// var sliderFactory = {
...
// Перенесли весь этот код в конструктр
// imagesUrls: [],
// currentImageIndex: 0,
